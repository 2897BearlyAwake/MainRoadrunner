...
public class Blue2Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj2 = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-24, 56, Math.toRadians(360)))
                .build();
        ...
        Trajectory traj4 = drive.trajectoryBuilder(traj3.end(), true)
                .lineToLinearHeading(new Pose2d(-24, 64, Math.toRadians(360)))
                .build();
        ...
        Trajectory traj6 = drive.trajectoryBuilder(traj5.end(), true)
                .lineToLinearHeading(new Pose2d(-24, 72, Math.toRadians(360)))
                .build();
